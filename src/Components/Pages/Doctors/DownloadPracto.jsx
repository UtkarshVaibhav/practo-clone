...
const DownloadPracto = () => {
  return (
    <div class={styles.downloadPracto}>
        <div>
            <img src="https://www.practostatic.com/web-assets/home/assets/images/download.a9fb5307ceed47df0af1f39cf4e95519.png" alt="PractoDoctorImage" width="350px" />
        </div>
        <div>
            <div>
                <h1 className={styles.heading}>Download the Practo app</h1>
